...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.ym_merchant_receipt'
        db.add_column(u'yandex_money_payment', 'ym_merchant_receipt',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Payment.ym_merchant_receipt'
        db.delete_column(u'yandex_money_payment', 'ym_merchant_receipt')
    ...
    models = {
        ...
        u'yandex_money.payment': {
            ...
            'ym_merchant_receipt': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        }
    }
